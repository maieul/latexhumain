...
On peut tracer un trait horizontal avec la commande \csp{rule}\oarg{profondeur}\marg{longueur}\marg{épaisseur}, ou \arg{profondeur} correspond à l'écart entre le trait et le bas de la ligne de texte.
