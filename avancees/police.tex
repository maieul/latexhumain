...
\item[ligne 12]on affiche en taille\cs{Huge} et en gras (\cs{bfseries}) titre du chapitre (\#1). On introduit ensuite un paragraphe (\csp{par}), en demandant d'éviter les changements de pages (\csp{nobreak}).
...
Il est possible de créer son propre compteur :
