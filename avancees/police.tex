...
L'option \option{Mapping=tex-text} des deux premières commandes permet de gérer de manière particulière certaine suite de caractères, par exemple de remplacer trois tirets courts (\verb|---|) par un tiret long (---).\renvois{tiret} 
