...
Concrètement, les commandes  \cs{markboth} et \cs{markright} sont appelées automatiquement dans la classe \classe{book} par les commandes \cs{chapter} et \cs{section} \emph{via} les commandes \csp{chaptermark} et \csp{sectionmark}. Ces commandes \cs{sectionmark} et \cs{chaptermark} sont par défaut définies ainsi:
 \begin{latexcode}
 \newcommand{\sectionmark}[1]{\thesection}
 \newcommand{\chaptermark}[1]{\thesection}
 \begin{latexcode}
