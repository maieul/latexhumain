...
Vous pouvez constater le résultat sur cette page.\thispagestyle{fancy}\cfoot{{\thepage} / \ref{TotPages}}}
...
Lorsqu'on utilise le style de page \arg{fancy}, on supprime automatiquement les styles par défaut, qui contiennent notamment les titres de chapitre et de section. On peut vouloir les restaurer, voire les modifier. Pour ce faire il est nécessaire de comprendre les mécanisme des marqueurs de \LaTeX. 
...
Concrètement dans la classe \classe{book}, les commandes  \cs{marboth} et \csp{markrightø sont appelées par les commandes \cs{chapter} et \cs{section} via les commandes \csp{chaptermark} et \csp{sectionmark}. 
