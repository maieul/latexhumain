...
\section{Style de la première page des chapitres}\label{entetechapter}

La première page des chapitres utilise le style \verb|plain|, et non pas \verb|heading|. Pour rétablir le style \verb|heading| le plus simple est de redéfinir la commande \commande{chapter}. Nous en parlons dans un autre chapitre.\renvoi{chapitrepagestyle}
