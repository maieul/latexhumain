...
Auparavant, il fallait compiler en ligne de commande\renvoi{terminal} suivant cette syntaxe :
...
Si nous préférons qu'elles soient simplement légèrement décalées vers la droite, nous pouvons utiliser, à la place de \textbackslash\cs{hfill}, \textbackslash\cs{hspace*}\verb|{1em}| qui rajoute à gauche un espace\renvoi{espace} d'un cadratin\renvoi{unite}. 
