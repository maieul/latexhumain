...
Auparavant, il fallait compiler en ligne de commande, selon cette syntaxe :\renvoi{terminal}
...
Le package \package{imakeidx}  évite de passer par le terminal : il suffit en effet de  donner à la commande \cs{makeindex} l'argument \oarg{options=-s  monstyle.ist}. 
