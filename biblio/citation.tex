...
\subsection{L'argument \argument{postnote} et la numérotation des pages}\label{pagespostnote}
...
Un problème se pose lorsqu'il y a déjà un champ \champ{pages} de rempli : on se retrouve avec deux numérotation de pages : celle indiquée dans le champ \champ{pages} et celle indiquée par l'option \argument{postnote}. Prenons l'entrée suivante :
...
Il est possible de citer autant d'œuvres que souhaité. Chaque élément cité a droit à son argument \argument{prenote} et \argument{postnote}, qui s'utilisent de la même manière que pour les citations simples.
