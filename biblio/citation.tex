...
\begin{attention}
Les versions anciennes de \package{biblatex} avaient un bug qui insérait par moment une espace en trop après le point-virgule de citations multiples. Vérifier que vous disposez bien de \package{biblatex}~2.0 ou supérieur. Le cas échéant, procédez à la mise à jour\renvoi{maj}.
\end{attention}
