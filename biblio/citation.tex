...
Un problème se pose lorsqu'il y a déjà un champ \champ{pages} remplit : on se retrouve avec deux numérotation de pages : celle indiquée dans le champ \champ{pages} et celle indiquée par l'option \argument{postnote}. Prenons l'entrée suivante :
