...
<<<<<<< HEAD
\item[alphabetic]chaque entrée reçoit un code correspondant au nom de l'auteur et à la date, code qui est appelée lorsque l'on renvoie à cette entrée. La bibliographie finale indique les correspondances.%Ajouté
\item[authortitle]se indica solamente el autor y el título de la obra.
\item[authortitle]sont indiqués seulement l'auteur et le titre de l'œuvre. Il existe des variantes qui permettent d'utiliser des abréviations si l'auteur est cité plusieurs fois de suite. Voir le manuel pour une description de ces variantes.%Modifié
\item[authoryear]sont indiqués seulement l'auteur et la date de l'œuvre. Il existe des variantes qui permettent d'utiliser des abréviations si l'auteur est cité plusieurs fois de suite. Voir le manuel pour une description de ces variantes.%Ajouté
=======
\item[authortitle]se indica solamente el autor y el título de la obra.
...
<<<<<<< HEAD
  \item[verbose-note]la description complète de l'entrée est donnée à sa première mention, puis une version abrégée est utilisée, avec un renvoi vers la note de bas de page de la première référence.%Modifié
=======
>>>>>>> 7415f8e (Update citation.tex)
