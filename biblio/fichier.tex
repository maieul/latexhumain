...
L'avantage de ce système se comprend  aisément. En effet, une correction dans la base de donnée bibliographique est automatiquement reportée dans le travail, moyennant une nouvelle compilation avec BibTeX, à chaque fois que l'entrée est mentionnée.
...
\begin{fieldlist}
	\fielditem{eid} Identifiant électronique d'une entrée de type \type{article}. 
   	...
   	\fielditem{ismn} \textenglish{International Standard Music Number}, pour les musiques imprimées, comme par exemple les partitions. 
   	\fielditem{isrn} \textenglish{International Standard Technical Report Number}, pour les rapports techniques. 
   	\fielditem{issn} \textenglish{International Standard Serial Number}, pour les numéros de revues. 
