...
\begin{fieldlist}
	\fielditem{afterword} Auteur(s) de la postface. 
   	...
   	\fielditem{editora} Éditeur(s) scientifique(s) ayant un autre rôle. On peut en préciser le rôle grâce au champ \champ{editoratype}.  
   	\fielditem{editorb} Éditeur(s) scientifique(s) ayant un autre rôle. On peut en préciser le rôle  grâce au champ \champ{editorbtype}.  
   	\fielditem{editorc} Éditeur(s) scientifique(s) ayant un autre rôle. On peut en préciser le rôle  grâce au champ \champ{editorctype}\footcite[Pour ces quatres champs, se reporter à][]{biblatex_editortype}.
