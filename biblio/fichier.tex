...
\begin{description}
\item[Un type d'entrée] \quad s'agit-il d'un article, d'un livre, d'actes de colloque ?
\item[Une clef unique] \quad qui permet de distinguer une entrée bibliographique d'une autre. C'est elle qui est mentionnée dans vos fichiers \ext{tex} lorsque vous désirez insérer une référence bibliographique.
...
\begin{description}
	...
	\item[Éventuellement une particule.] \quad Elle doit être entièrement en minuscules. Par exemple : \forme{de}, \forme{von}.
	\item[Éventuellement un suffixe.] \quad L'initiale doit être en majuscule. Ce type de donnée est plutôt anglo-saxonne. Exemple : \forme{Junior}.
\end{description}
