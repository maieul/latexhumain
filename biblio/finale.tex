...
\item Le second argument, ici \csp{bibname} correspond au titre par défaut. Dans notre cas, la commande \csp{bibname} renvoie simplement la valeur \forme{Bibliographie}.
