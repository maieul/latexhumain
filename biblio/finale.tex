...
Une autre manière de  sectionner une bibliographie est de faire des parties thématiques. Pour cela, une solution est d'indiquer des mots-clefs dans le champ \champ{keywords} des entrées bibliographiques. Les mots clefs doivent être séparés par des virgules.
