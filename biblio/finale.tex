...
Analysons ce code :
\begin{enumerate}
\item Le premier argument correspond au nom de l'entête de bibliographie (du titre de bibliographie). L'entête nommé \forme{bibliography} est celui utilisé par défaut. Mais on pourrait très bien définir un entête \forme{toto}, il suffirait alors de passer un argument \arg{heading} à la commande \cs{printbibliography}.
