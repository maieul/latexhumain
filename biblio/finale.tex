...
On peut vouloir ajouter dans une bibliographie des références qui n'ont pas été explicitement citées dans le texte. Il faut  utiliser la commande :
...
Pour résoudre ce problème,  on peut certes utiliser le champs \champ{sortname}, mais le plus sain est de définir sa propre règle de tri : nous expliquons comment sur notre blog\footcite{trianonyme}.
\end{attention}
