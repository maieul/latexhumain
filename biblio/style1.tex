...
On peut là aussi modifier le séparateur en redéfinissant la commande \csp{multicitedelim}. Par exemple pour avoir une virgule :
...
Il est parfois d'usage de mettre la particule entre parenthèses. Il faut pour cela redéfinir la commande \csp{mkbibnameprefix}. Cette commande prend un argument, qui est la particule. Pour la mettre automatiquement entre parenthèse, il suffit ainsi d'écrire.
