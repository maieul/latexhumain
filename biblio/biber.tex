...
En toute logique la compilation avec BibTeX devrait attribuer la valeur du champ \champ{title} de l'entrée \verb|principale| aux champs \champ{booktitle} des entrées \verb|clef1| et \verb|clef2|, puisqu'il s'agit d'entrée de type \type{inproceedings} héritant d'entrée \type{proceedings}. 
...
\begin{description}
\item[entrée mère]désigne le type d'entrée mère : \type{book}, \type{proceedings} etc. Le symbole * désigne n'importe quel type d'entrée
