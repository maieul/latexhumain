...
\begin{attention}
Il n'est pas (encore) possible d'avoir des sous-sous-entrées bibliographiques, c'est à dire de faire référence dans le champ \champ{crossref} à une entrée ayant elle-même un champ \champ{crossref}.
\end{attention}
