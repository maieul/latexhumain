...
\begin{attention}
Il n'est pas  possible d'avoir des sous-sous-entrées bibliographiques, c'est à dire de faire référence dans le champ \champ{crossref} à une entrée ayant elle-même un champ \champ{crossref}.

La version 0.9.6 de Biber, en cours de développement à l'heure où nous écrivons ces lignes, le permettra.
\end{attention}
