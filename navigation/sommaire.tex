...
Le package \package{minitoc} est très complexe et contient de nombreuses subtilités ; il permet  par exemple choisir facilement les styles du sommaire. Nous renvoyons au manuel pour plus de détails\footcite[Notamment][]{minitoc_typesetting}.
