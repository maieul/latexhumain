...
Pour notre cas, on peut aisément repérer la ligne contenant \cs{def}\csp{contentsname}\verb|{Table des matières}%|.
...
Les commandes \TeX{} peuvent contenir des \enquote{sous-commandes}. Ici par exemple, la commande \cs{captionfrench} contient la sous-commande \cs{contentsname}. Nous utilisons la commande \TeX{} \csp{gappto} pour injecter une sous-commande dans une commande déjà définie.
