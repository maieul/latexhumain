...
Tous les formatages d'entrées que l'on a vu pour \package{makeindex} fonctionnent également avec \package{splitindex}


\subsection{Imprimer les index}
printindex*
ou printindex+noms des index si on ne veut pas tout les index

mettre remarque > comment tout repasser à un seul index : \verb|\usepackage[allatone]{splitidx}|
