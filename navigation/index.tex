...
On peut ainsi référencer autrement notre premier exemple, en créant les entrées \enquote{Eveques} et \enquote{Ducs} que l'on subdivise:
...
part du pape, les évêques Formose\index{Eveques!Formose}
et Damase\index{Eveques!Damase}\textelp{}.
\end{latexcode}
...
Bien entendu, on pourrait encore rajouter une subdivision, en distinguant par exemple \enquote{Clercs} et \enquote{Laïcs}, et dans la première catégorie en distinguant \enquote{Eveques} et \enquote{Papes}. 
