...
Le package se charge en remplçant la commande \verb|\usepackage{makeindex}| par \verb|\usepackage{splitidx}| tout en gardant ensuite \cs{makeindex} dans le préambule, ou bien en mettant simplement  \verb|\usepackage[makeindex]{splitidx}|.
