...
On peut souhaiter que notre index soit indiqué dans la table des matières. On pourrait utiliser la commande \commande{addcontentsline} de la manière suivante :
