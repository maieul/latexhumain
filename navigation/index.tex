...
des ambassadeurs à Tassilon, duc de Bavière\index{Tassilon}\textelp{}
...
des ambassadeurs à Tassilon, duc de Bavière\sindex[npr]{Tassilon}\textelp{}
Les hommes choisis et envoyés dans cette ambassade furent, de 
...
Pour imprimer un index, il suffit d'utiliser la commande \csp{printindex*} en lui passant le nom abrégé de l'index en argument. Ainsi pour imprimer l'index de noms propres:
...
\begin{description}
\item[ligne 2] la commande \csp{ifciteindex} vérifier que l'option \option{indexing} de \package{biblatex} est bien égale à \verb|true| ou bien à \verb|cite|, si tel est le cas ce qui suit entre accolades est exécuté.
