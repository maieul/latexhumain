...
Si notre fichier principal s'appelle \fichier{exemple.tex},  la commande \cs{makeindex} indique à \LaTeX{}, lors de la compilation avec \XeLaTeX , de créer un fichier \fichier{exemple.idx}, contenant la liste de toutes les entrées que l'on a placées. 
...
Après cela, la compilation avec XeLa
