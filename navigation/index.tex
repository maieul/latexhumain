...
part du pape, les évêques Formose\index{Éveques!Formose}
et Damase\index{Éveques!Damase}\textelp{}.
\end{latexcode}
...
Bien entendu, on pourrait encore rajouter une subdivision, en distinguant par exemple \enquote{Clercs} et \enquote{Laïcs}, et dans la première catégorie en distinguant \enquote{Éveques} et \enquote{Papes}. 
...
\begin{description}
\item[ligne 2] la commande \csp{ifciteindex} vérifie que l'option \option{inde\-xing} de \package{biblatex} est bien égale à \verb|true| ou bien à \verb|cite|: ce qui suit entre accolades est exécuté si tel est le cas.
