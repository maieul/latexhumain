...
\item Télécharger le fichier \url{https://github.com/maieul/indexation-sources/zipball/stable} et recopier les fichiers \fichier{index.py} et \fichier{roman.py} à coté de votre fichier principal.
