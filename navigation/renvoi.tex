...
Cet étiquetage  se fait avec la commande \cs{label{etiquette}}.
...
Pour renvoyer au numéro de page correspondant à l'étiquette \argument{etiquette} il suffit d'utiliser la commande \cs{pageref}\marg{etiquette}.
...
Pour renvoyer à un numéro de section, il suffit d'utiliser la commande \cs{ref}.
...
Pour renvoyer à un titre de section, il suffit d'utiliser la commande \cs{nameref}.
...
Vous êtes bien sûr libre de trouver votre propre système de nommage d'étiquette. Toutefois il est d'avoir quelque chose de la forme : \contenuarg{type:nom}, où \contenuarg{forme} désigne le type d'élément vers lequel on renvoie.
