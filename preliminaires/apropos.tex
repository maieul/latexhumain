...
Il va de soi que ce livre a été composé avec \XeLaTeX. Outre les packages dont il traite, j'ai utilisé le package  \package{minted} pour les citations de code ; ainsi que \package{mdframed} et \package{framed} pour les boîtes colorées.
