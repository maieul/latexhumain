...
Il va de soi que ce livre a été composé avec \XeLaTeX. Outre les packages dont il traite, j'ai utilisé les packages \package{multicol} pour gérer finement le double colonnage de l'index ; \package{ltxdockit} et \package{minted} pour les citations de code ; \package{mdframed} pour les boîtes colorées, et enfin, \package{bidi} pour les logos \XeLaTeX et \XeTeX.
