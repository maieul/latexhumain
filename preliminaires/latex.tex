...
Une première partie sera donc consacrée à présenter les bases de \LaTeX. Le premier chapitre, sous forme de tutoriel, vise à présenter les concepts de base de \LaTeX. Les autres chapitres, plus formels, décrivent les outils de bases et nécessitent d'avoir compris les concepts. En revanche leur ordre de lecture dépend essentiellement des besoins rédactionnels du lecteur. 
