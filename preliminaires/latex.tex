...
\begin{anedocte}
Bien que le sujet soit controversé, il semblerait qu'on prononcerait le  \forme{X} de \TeX{} comme un \forme{χ} grec\footnote{\forme{Latek}}, car le nom \TeX{} viendrait du mot grec \forme{\TeX{}tgreek{τέχνη}} : \forme{art, sciences}
\end{anedocte}