...
\begin{longtable}{|lp{15em}|}
    \hline
    \headlongtable{Commande} & \headlongtable{Explication} \\
    \hline
    \endhead
    \hline
    \endfoot
...
Cette syntaxe est utilisée dans les commandes de définitions des en-têtes de section, sous une forme légèrement différente : \cs{@plus} et \cs{@minus} ne sont que des alias \LaTeX des mot clefs \TeX \verb|plus| et \verb|minus|.\renvoi{apparencetitre}
