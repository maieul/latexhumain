...
Les livres sur \LaTeX sont pléthores. Cependant la plupart n'abordent ni \XeLaTeX, ni \package{polyglossia}, ni \package{biblatex}. C'est pourquoi je conseille de les utiliser essentiellement pour les besoins les plus avancés de mise en page.
