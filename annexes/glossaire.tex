...
\item[Préambule] partie du code \ext{tex} située avant \cs{begin}\oarg{environnement}. Son contenu n'est pas affiché dans le document final, mais sert à divers usages, notamment le chargement de packages.

\item[Style bibliographique] manière d'afficher une entrée bibliographique, indépendamment de son contenu sémantique. Le package \package{biblatex} propose un certains nombres de styles bibliographiques, qu'il est possible de personnaliser. 
