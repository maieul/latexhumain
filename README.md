...
1) soit créer un ticket en vous rendant sur https://github.com/maieul/latexhumain/issues
2) soit carrément écrire l'amélioration et la proposer via une "Pull Request". 
