...
\begin{itemize}
	...
	\item Par le caractère \enquote{\textenglish{greek small letter alpha}} (\verb|U+03B1|) suivi du caractère \enquote{\textenglish{combining greek ypogegrammeni}} (\verb|U+0345|). 
\end{itemize}

En théorie, les deux polices de caractères doivent afficher le même résultat avec ces deux encodages. En pratique, il n'en va pas toujours ainsi. C'est pourquoi il est recommandé de mettre le code suivant dans le préambule :
\begin{latexcode}
