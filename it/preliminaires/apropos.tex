\phantomsection\addcontentsline{toc}{section}{A proposito di questo libro}\section*{A proposito di questo libro}\thispagestyle{plain}

Va da sé che questo libro è stato interamente redatto con \XeLaTeX. A parte i pacchetti qui trattati, ho utilizzato il pacchetto \package{minted} per le citazioni di codice, i pacchetti \package{mdframed} e \package{framed} per i riquadri colorati.
