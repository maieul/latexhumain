...
\item Remplir un fichier .bib
	\begin{enumerate}
	\item La notion de clef \& syntaxe de base\marginpar{Renvoi vers logiciels.}
	\item Les différents champs\marginpar{Là je risque d'avoir besoin de pas mal de tableau}
		\begin{enumerate}
			...
			\item Les champs d'organisation\marginpar{Trouver un titre plus générique} : Library, Keywords, Annotation etc.
