...
\renewcommand{\chaptermark}[1]{\markboth{%
	\@chapapp~\thechapter\hfill#1}{%
	\@chapapp~\thechapter\hfill#1}}
\renewcommand{\sectionmark}[1]{\markright{\emph{#1}\hfill§\thechapter,\thesection}}
...
%Pour entete d'index
\let\imki@indexheaders\relax 
\newcommand{\vide}[1]{\relax}
\patchcmd{\theindex}{\thispagestyle}{\vide}{}{}
%Pour entete de sommaire
\pretocmd{\tableofcontents}{\fancyhead[LE]{}%
\fancyhead[RO]{}%
}{}{}
\makeatother
