...
\usepackage[backgroundcolor=shadecolor,linecolor=white,innertopmargin=0.5\baselineskip,innerbottommargin=0.5\baselineskip]{mdframed}		% Pour les fonds grisés
\usepackage{framed}
