...
\usepackage{multicol}				%Pour une gestion avancées de plusieurs colonnes, pour l'index. nécéssaire d'appeler cela avant le package bidi, sinon certaines options de imakeidx ne fonctionnent pas
