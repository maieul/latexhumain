...
Il existe   cinq styles pour numéroter les lignes, sélèctionnés par la commande 
\cs{linenumberstyle}\marg{style}, ou pour les sous-numérotations par\cs{sublinenumberstyle}{\marg{style}).
