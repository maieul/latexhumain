...
La commande \csp{setline}\marg{num} permet de changer le numéro d'une ligne. La numérotation des lignes suivantes  continue à partir de ce nombre ; \cs{advanceline}\marg{num} permet d'ajouter \arg{num} au numéro de la ligne.
...
\csp{linenumberstyle}\marg{style}, \csp{sublinenumberstyle}\marg{style} pour la sous-numérotation :
...
Par ailleurs, si vous utilisez la commande \cs{numberpstarttrue}\renvoi{numberpstarttrue} pour numéroter les \cs{pstart}s, sachez que la numérotation gauche et la numérotation droite fonctionnent avec deux compteurs différents : \compteur{pstartL} et \compteur{pstartR}\renvoi{apparencecompteur}[manipcompteurs].
\end{plusloins}
