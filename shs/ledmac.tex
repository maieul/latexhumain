...
\begin{intro}
Nous allons aborder ici deux packages particulièrement utiles en sciences humaines : \package{ledmac} pour faire des éditions critiques et \package{ledpar} (qui ne peut être utilisé séparément de \pakage{ledmac}) pour éditer un texte et sa traduction en parallèle.
