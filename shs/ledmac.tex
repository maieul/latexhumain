...
\cs{linenumsep} représente la distance entre le texte et le numéro de la ligne\renvoi{unite}, par défaut, 1~pica. 

Cette distance est donc modifiable par la commande \cs{setlength}\verb|{|\cs{linenumsep}\verb|}|\marg{distance}\renvoi{setlength}. 

On peut de la même façon modifier \cs{numlabfont}, qui indique la taille du numéro et qui est ainsi définie:
 \cs{newcommand}\verb|{|\cs{numlabfont}\verb|}{|\cs{normalfont}\cs{scriptsize}\verb|}|. 
 
On peut donc la redéfinir avec \cs{renewcommand}.
