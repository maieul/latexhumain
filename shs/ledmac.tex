...
On débute la numérotation des lignes, au sein de cet environnement numbering, avec la commande \csp{pstart} et on la termine avec la commande \csp{pend} comme dans l'exemple suivant:
...
\renewcommand{\endstanzaextra}{\bigbreak}
\stanza
Berlin setz an.&
...
\cs{renewcommand}\verb={=\cs{endstanzaextra}\verb=}{=\csp{bigbreak}\verb=}=. La commande\csp{bigbreak}  insère un espace vertical. 
