...
Si l'indentation se répète tout les \emph{n} vers, on peut assigner la valeur \emph{n} au compteur \compteur{stanzaindentsrepetition} pour ne pas avoir à répéter l'indentation dans la commande \cs{setstanzaindents}. \renvoi{compteur}
...
La distance \csp{linenumsep} représente la distance entre le texte et le numéro de la ligne\renvoi{unite}, par défaut, 1~pica. 
