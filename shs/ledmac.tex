...
\begin{attention}
Si votre sections numérotées sont très longues, il peu arriver d'avoir une erreur de compilation \forme{TeX capacity exceeded}. Une solution\footnote{Une autre solution serait de régler la configuration de \TeX pour lui allouer plus de mémoire.} est  d'utiliser de temps en temps dans le texte la commande \csp{pausenumbering} suivie de \csp{resumenumbering} au sein de  la section numérotée.
...
On commence la sous-numérotation par \csp{startsub} et on la finit par \csp{ensub}.
