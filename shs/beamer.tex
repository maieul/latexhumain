...
Il existe plusieurs manières de mettre en valeur certains éléments d'une diapositive. La première  consiste à les placer dans des blocs pour les encadrer. \classe[beamer]{Beamer} propose plusieurs blocs standards, qui prennent à la fois un titre et un contenu. Ces blocs\footcites[Il est possible de créer ses propres blocs : voir  ][]{beamer_box}[il existe aussi des éléments proches des blocs que sont les encadrés, pour mettre en valeur des définitions, des théorèmes : voir][]{beamer_theorems} sont  : bloc standard, bloc d'exemple et bloc d'alerte.
