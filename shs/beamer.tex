...
La commande \cs{alert} sert à mettre en valeur une partie d'un texte. Elle peut recevoir une spécification de couche. Cela est très utile pour indiquer à l'auditoire le sujet dont on parle. 
...
On peut afficher plusieurs notes sous forme de liste en passant  à la commande \cs{note} un argument optionnel ayant pour valeur \contenuarg{item}.
