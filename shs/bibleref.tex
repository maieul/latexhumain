...
On choisit son style par la commande \commande{biblerefstyle}, qu'il est conseillé de mettre en préambule.
\begin{minted}{latex}
\biblerefstyle{style}
\end{minted}
...
On peut remplacer la commande \commande{bibleverse} par la commande \commande{ibibleverse}. Celle-ci indexe une référence biblique, en plus de l'afficher.
...
Pour éviter cela, on peut autoriser temporairement la coupure des espaces entre un livre et un numéro de chapitre. La commande \commande{BRallowhypbch} marque le début de l'autorisation ; \commande{BRforbidhypbch} en marque la fin.
