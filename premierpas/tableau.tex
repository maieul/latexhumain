...
\begin{anedocte}Pour afficher un graphique statistique, nous recommandons d'utiliser le package \package{TikZ}\renvoi{TikZ} et les nombreux packages dérivés. Toutefois le \package{csvtools} possède une fonction pour tracer un diagramme circulaire à partir d'un fichier \ext{csv}. Nous renvoyons à sa documentation.
