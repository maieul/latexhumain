...
\item\commande{appendix} affiche les numéros de titres sous forme de lettres majuscules.
\item\commande{backmatter} supprime les numéros de titre mais présent dans la table des matières. Mais 
\end{enumerate}
