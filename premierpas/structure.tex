...
\logiciel{\LaTex} propose par défaut six ou sept niveaux de titre, selon la classe choisie.
Pour introduire un titre dans \logiciel{\LaTex} --- en dehors du titre du travail ---, il suffit d'utiliser une commande de titre, qui possède la syntaxe suivante:
\begin{minted}{latex}
...
Jusqu'à maintenant, vous aviez tout mis dans un seul fichier. Une fonctionalité intéressante de \logiciel{\LaTeX} est la possibilité d'inclusion des fichiers dans un fichier, pour ainsi séparer son travail en plusieurs fichiers, chaque fichier contenant une partie seulement du document final.
