...
Le premier \concept{package} utilisé est \package{xunicode}. Il permet de gérer \concept[unicode]{l'unicode}, autrement appelé \concept{utf-8}\footnote{En réalité \concept{utf-8} n'est pas tout à fait \concept{unicode}, mais simplement une variante de ce dernier. Toutefois, pour simplifier, nous assimilerons les deux.} ; c'est cela qui nous permettra d'avoir des caractères non-latin\renvoi{utf-8}.
