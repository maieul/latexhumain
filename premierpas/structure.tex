...
\subsection{La classe \classe{book} : structuration globale du document}

La classe \classe{book} propose, au delà des niveaux de titres, une manière de structurer en trois parties sont travail : préambules (avant-propos, sommaire, introductions etc.) ; corps du travail ; annexes (index, glossaires, tables des matières etc.). 
