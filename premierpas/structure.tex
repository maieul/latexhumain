...
Regardez le résultat obtenu, nous allons lire le code que vous avez copié et le commenter ligner par ligne, afin de comprendre les principes de base de \logiciel{LaTex}.
\FloatBarrier
