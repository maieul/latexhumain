...
Le premier \concept{package} est \package{fontspec}. Le second \concept{package} est \package{xunicode}. Il permet de gérer \concept[unicode]{l'unicode}, autrement appelé \concept{utf-8}\footnote{En réalité \concept{utf-8} n'est pas tout à fait \concept{unicode}, mais une implémentation de ce dernier. Toutefois, pour simplifier, nous assimilerons les deux.}. Ces deux packages nous permettront d'avoir des caractères non-latin\renvoi{utf-8}.
