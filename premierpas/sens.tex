...
En revanche, si à la place de signaler une mise en petite capitale, j'avais simplement signalé qu'il s'agit d'un nom d'auteur -- par exemple en écrivant : \verb|\auteur{Tertullien}| -- je n'aurais qu'une seule ligne à changer pour indiquer que je souhaite avoir mes noms d'auteur en gras. Mieux : je pourrais créer très simplement un index de mes auteurs\renvoi{indexauteur}.
