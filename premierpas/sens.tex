...
\begin{anedocte}
Il existe un package \package{etaremune} qui permet d'avoir un environnement  \environnement{etaremune} pour avoir des listes numérotées à l'envers (avec le plus grand nombre en début de liste).
