...
Ce qui donne le résultat de la figure~\ref{figure:genealogie}\renvoi{figure:genealogie}. Analysons le code :
...
\begin{plusloins}
On peut simuler certaines fonctionnalités d'un tableau à l'aide du package \package{spreadtab}\footcite{spreadtab}.
\end{plusloins}
...
Pour éviter cela, il faut  utiliser l'environnement \enviro{longtable} du package éponyme\sindex[pkg]{longtable}.
