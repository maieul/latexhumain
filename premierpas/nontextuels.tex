...
Nous allons donc ici vous présenter sommairement les possibilités du package \package{TikZ}. Nous renvoyons toutefois à d'autres ouvrages pour un approfondissement et des exemples plus détaillées\footcites[Outre le manuel on pourra lire][]{tikzimpatient}[on pourra également consulter le site ][]{tikzexample}.
...
\subsection{Premier exemple : arbre représentant des familles de manuscrits}
...
Ce qui donne le résultat de la figure\ref{figure:genealogie}\renvoi{figure:genealogie}.
