...
La première ligne \csp{documentclass}\verb|[12pt,a4paper]{book}| déclare la classe du document, ici \classe{book}. Une classe correspond à un choix éditorial    --- mise en page et organisation générale du document. Le choix de la classe influence entre autres :
\begin{itemize}
