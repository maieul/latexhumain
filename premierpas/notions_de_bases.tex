...
Jedes \LaTeX-Dokument beginnt mit der Deklaration der Dokumentenklasse. Die Syntax lautet: \cs{documentclass}\oarg{options}\marg{classe}.

\begin{attention}
In diesem Buch ist jeder Text, der sich in spitzen Klammern befindet (\arg{wie hier}), in Ihrer \ext{tex}-Datei durch einen bestimmten Wert zu ersetzen.
\end{attention}
