...
Das erste Package ist \package{fontspec}. 
Il est utile à \XeLaTeX  pour une typographie avancée, notamment pour disposer d'accents dans le document PDF produit. 
...
Das zweite manuell geladene Package \package{polyglossia} ermöglicht, auf einfache Weise ein mehrsprachiges Dokument zu erzeugen, wobei die nötigen typographischen Anpassungen vorgenommen worden.
