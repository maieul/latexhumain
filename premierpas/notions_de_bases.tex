...
Alles, was wir bislang betrachtet haben, der Teil vor \cs{begin}\verb|{document}|, gehört zur sogenannten Präambel des Dokuments.\label{preambule} Es handelt sich hierbei um Informationen, die nicht im erzeugten Dokument erscheinen werden, aber bei dessen Erstellung berücksichtigt werden, um Metadaten also. Alle Packages, die sie verwenden möchten, müssen in der Präambel geladen werden.
