...
La première ligne \verb|\documentclass[12pt]{book}| déclare la classe du document, ici \classe{book}. Une classe correspond à un choix éditorial    ---mise en page et organisation générale du document ---. Le choix de la classe influencera entre autre :
\begin{itemize}
