...
\LaTeX produce automáticamente un espacio fino ante los signos de puntuación dobles, \verb|!:;?| principalmente, como se ha de hacer en buena tipografía francesa\footnote{Un espacio fino es un espacio más pequeño que un espacio normal.}. Sin embargo, recomendamos incluir espacios en el fichero \ext{tex} ante estos signos de puntuación dobles, para facilitar la lectura.
