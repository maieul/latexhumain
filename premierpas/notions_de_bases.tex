...
\begin{attention}
Dans la suite de ce livre, tout texte situé entre crochets (\meta{ainsi}), doit être remplacé dans votre fichier \ext{tex} par une valeur textuelle.
\end{attention}
...
\begin{description}
\item[\textbackslash]qui s'insère avec la commande \csp{\textasciicircum} ;
\item[\textasciitilde]qui s'insère avec la commande \csp{\textasciitilde} ; 
\item[\textasciicircum]qui s'insère avec la commande \csp{\textasciicircum}. 
\end{description} 
...
On marque le début d'un environnement  \meta{nom} par la commande \csp{\begin}\marg{nom} et on le termine par la commande \csp{\end}\marg{nom}.
